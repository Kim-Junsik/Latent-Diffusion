...
# CUDA_VISIBLE_DEVICES=0 python test_for_evaluation.py --eta=0.0 --ddim_step=500 --training_path='_stage2_pre_2'
# CUDA_VISIBLE_DEVICES=0 python test_for_evaluation.py --eta=0.0 --ddim_step=500 --external --training_path='_stage2_pre_2'
